...
$(document).ready(function () {
    ...
    getCurrentUser(function (user) {
        ...
        getProfileData(user, function (profileData) {
            ...
            $("#name").val(unescape(profileData['classLabelName']));
            $("#dob").val(profileData['lblDOB']);
            $("#userid").val(user);
            $("#location").val(unescape(profileData['lblLocation']));
            if (profileData['imgLabelImage'] != '') {
    ...
    $("#btnSubmit").click(function () {
        var fields = form2json($("#frmProfile"));
